...
output "postgresql_server_name" {
  value = module.azure_postgresql_server.pgsql_server_name
}

output "postgresql_login_username" {
  value = module.azure_postgresql_server.login_username
}

output "postgresql_database_name" {
  value = module.azure_postgresql_server.pgsql_database_name
}